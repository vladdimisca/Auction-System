...
module.exports = {
  ...
  networks: {
   ...
   /* ropsten: {
      provider: () => new HDWalletProvider(process.env.MNEMONIC, `https://ropsten.infura.io/v3/c23b8410ec134b3684634520ad2b365c`),
  ...
  compilers: {
    solc: {
      ...
      // settings: {          // See the solidity docs for advice about optimization and evmVersion
        optimizer: {
          enabled: true, //false for Ganache using
          runs: 200
        },
